...
Input JSON schema (list of slide objects):
  [
    {
      "title":     "Slide title",
      "tag":       "SECTION LABEL",            // optional
      "bullets":   ["bullet 1", "  sub-item"], // on-slide text
      "narration": "Full narration text.",     // goes into Notes
      "image_page": 3                          // optional: extract from PDF page N
    },
    ...
  ]
